export output_dir_name="proftpdChModCmnd3"
...
sleep 8
send_cmnd "site chmod 777 /tmp/file.txt"
rm /tmp/file.txt
$pftpstop
...
############################################################# 
touch /tmp/file.txt
$tracer -f "chgrp" -i "file0" -r 1 -o $traces_path -- $program -n -c /tmp/PFTEST/PFTEST.conf &
sleep 8
